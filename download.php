...
$filesShort = array(
	...
	'stendhal.zip', "stendhal-FULL.zip", 'stendhal-server.zip', 'stendhal-src.tar.gz',
	'stendhal-changes.txt', 'org.stendhalgame.client.apk');
$filesLong = array(
	...
	'stendhal-(version).zip', 'stendhal-(version).zip', 'stendhal-server-(version).zip', 'stendhal-(version)-src.tar.gz',
	'stendhal-(version)-changes.txt', 'org.stendhalgame.client-(version).apk');
